                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 ">
                        <div class="video-text-block text-center">
                            ...
                            <a class="btn btn-theme-color" href="#">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="content">
                            <div class="grid row">
                                <div class="grid__item col-md-3" data-size="1280x857">
                                    <a href="img/work/img-6.jpg" class="img-wrap">
                                        <img src="img/work/img-6.jpg" alt="img06">
                                        ...
                                        <div class="description description--grid">
                                            ...
                                            <div class="details">
                                                <ul>
                                                    <li><i class="fa fa-venus"></i><span>Canon PowerShot S95</span></li>
                                                    <li><i class="fa fa-venus"></i><span>22.5mm</span></li>
                                                    <li><i class="fa fa-venus"></i><span>&fnof;/5.6</span></li>
                                                    <li><i class="fa fa-venus"></i><span>1/1000</span></li>
                                                    <li><i class="fa fa-venus"></i><span>80</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="grid__item col-md-3" data-size="1280x1280">
                                    <a href="img/work/img-4.jpg" class="img-wrap">
                                        <img src="img/work/img-4.jpg" alt="img07">
                                        <div class="grid-overlay">
                                            <i class="fa fa-search" aria-hidden="true"></i>
                                            <div class="grid-title">
                                                <p>Designs</p>
                                ...
                                <div class="grid__item col-md-3" data-size="1280x853">
                                    <a href="img/work/img-3.jpg" class="img-wrap">
                                        <img src="img/work/img-3.jpg" alt="img08">
                                        <div class="grid-overlay">
                                            <i class="fa fa-search" aria-hidden="true"></i>
                                            <div class="grid-title">
                                                <p>Designs</p>
                                ...
                                <div class="grid__item col-md-3" data-size="865x1280">
                                    <a href="img/work/img-2.jpg" class="img-wrap">
                                        <img src="img/work/img-2.jpg" alt="img09">
                                        <div class="grid-overlay">
                                            <i class="fa fa-search" aria-hidden="true"></i>
                                            <div class="grid-title">
                                                <p>Designs</p>
                                ...
                                <div class="grid__item col-md-6" data-size="1280x1280">
                                    <a href="img/work/img-1.jpg" class="img-wrap">
                                        <img src="img/work/img-1.jpg" alt="img10">
                                        <div class="grid-overlay">
                                            <i class="fa fa-search" aria-hidden="true"></i>
                                            <div class="grid-title">
                                                <p>Designs</p>
                                ...
                                <div class="grid__item col-md-3" data-size="1280x1280">
                                    <a href="img/work/img-5.jpg" class="img-wrap">
                                        <img src="img/work/img-5.jpg" alt="img10">
                                        <div class="grid-overlay">
                                            <i class="fa fa-search" aria-hidden="true"></i>
                                            <div class="grid-title">
                                                <p>Designs</p>
                                ...
                                <div class="grid__item col-md-3" data-size="1280x850">
                                    <a href="img/work/img-6.jpg" class="img-wrap">
                                        <img src="img/work/img-6.jpg" alt="img11">
                                        <div class="grid-overlay">
                                            <i class="fa fa-search" aria-hidden="true"></i>
                                            <div class="grid-title">
                                                <p>Designs</p>
